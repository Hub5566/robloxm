...
local function T(text)
    local translations = {
        ...
        ["Info Section"] = "信息区域",
        ["Main Section"] = "主功能区域",
        ["Farming Section"] = "刷取区域",
        ["Items Section"] = "物品区域",
        ["Settings Section"] = "设置区域",
        ["Local Player Section"] = "本地玩家区域",
        ["Stats Section"] = "属性区域",
        ["Sea Event Section"] = "海上事件区域",
        ["Sea Stack Section"] = "海上堆叠区域",
        ["Sea Settings Section"] = "海上设置区域",
        ["Dragon Dojo Section"] = "龙道场区域",
        ["Race Section"] = "种族区域",
        ["Combat Section"] = "战斗区域",
        ["Raid Section"] = "副本区域",
        ["Esp Section"] = "透视区域",
        ["Teleport Section"] = "传送区域",
        ["Shop Section"] = "商店区域",
        ["Fruit Section"] = "恶魔果实区域",
        ["Misc Section"] = "杂项区域",
        ["Server Section"] = "服务器区域",
        
        -- 配置表翻译（覆盖核心字段）
        ["Select Weapon"] = "选择武器",
        ["Farm Level Method"] = "刷级方式",
        ["Auto Farm"] = "自动刷级",
        ["Auto Fast Farm"] = "快速刷级",
        ["Mastery Method"] = "熟练度方式",
        ["Auto Farm Fruit Mastery"] = "自动刷果实熟练度",
        ["Auto Farm Gun Mastery"] = "自动刷枪械熟练度",
        ["Selected Mastery Sword"] = "选择熟练度剑",
        ["Auto Farm Sword Mastery"] = "自动刷剑熟练度",
        ["Auto Summon Tyrant Of The Skies"] = "自动召唤天空暴君",
        ["Auto Kill Tyrant Of The Skies"] = "自动击杀天空暴君",
        ["Selected Mon"] = "选择怪物",
        ["Auto Farm Mon"] = "自动刷怪物",
        ["Selected Boss"] = "选择BOSS",
        ["Auto Farm Boss"] = "自动刷BOSS",
        ["Auto Farm All Boss"] = "自动刷所有BOSS",
        ["Farm Distance"] = "刷怪距离",
        ["Player Tween Speed"] = "玩家移动速度",
        ["Bring Mob"] = "吸引怪物",
        ["Bring Mob Mode"] = "吸引怪物模式",
        ["Fast Attack"] = "快速攻击",
        ["Fast Attack Mode"] = "快速攻击模式",
        ["Attack Aura"] = "攻击光环",
        ["Hide Notification"] = "隐藏通知",
        ["Hide Damage Text"] = "隐藏伤害文字",
        ["Black Screen"] = "黑屏模式",
        ["White Screen"] = "白屏模式",
        ["Hide Monster"] = "隐藏怪物",
        ["Mastery Health"] = "熟练度保留血量(%)",
        ["Fruit Mastery Skill Z"] = "果实熟练度技能Z",
        ["Fruit Mastery Skill X"] = "果实熟练度技能X",
        ["Fruit Mastery Skill C"] = "果实熟练度技能C",
        ["Fruit Mastery Skill V"] = "果实熟练度技能V",
        ["Fruit Mastery Skill F"] = "果实熟练度技能F",
        ["Gun Mastery Skill Z"] = "枪械熟练度技能Z",
        ["Gun Mastery Skill X"] = "枪械熟练度技能X",
        ...
        ["Auto Add Sword Stats"] = "自动加剑属性",
        ["Auto Add Gun Stats"] = "自动加枪属性",
        ["Point Stats"] = "每次加点数",
        ["ESP Player"] = "透视玩家",
        ["ESP Chest"] = "透视宝箱",
        ["ESP DevilFruit"] = "透视恶魔果实",
        ["ESP RealFruit"] = "透视真实果实",
        ["ESP Flower"] = "透视花朵",
        ["ESP Island"] = "透视岛屿",
        ["ESP Npc"] = "透视NPC",
        ["ESP Sea Beast"] = "透视海兽",
        ...
        ["Melee C Skill"] = "近战技能C",
        ["Melee V Skill"] = "近战技能V",
        ["Tween To Frozen Dimension"] = "传送至冰冻维度",
        ["Summon Frozen Dimension"] = "召唤冰冻维度",
        ["Tween To Kitsune Island"] = "传送至狐火岛",
        ["Summon Kitsune Island"] = "召唤狐火岛",
        ["Auto Collect Azure Ember"] = "自动收集蔚蓝余烬",
        ["Set Azure Ember"] = "蔚蓝余烬数量",
        ["Auto Trade Azure Ember"] = "自动交易蔚蓝余烬",
        ["Tween To Mirage Island"] = "传送至幻影岛",
        ["Teleport To Advanced Fruit Dealer"] = "传送至高级果实商人",
        ["Auto Attack Seabeasts"] = "自动攻击海兽",
        ["Summon Prehistoric Island"] = "召唤史前岛",
        ["Tween To Prehistoric Island"] = "传送至史前岛",
        ["Auto Kill Lava Golem"] = "自动击杀熔岩魔像",
        ["Auto Race V2"] = "自动种族V2",
        ["Auto Race V3"] = "自动种族V3",
        ["Selected Place"] = "选择地点",
        ["Teleport To Place"] = "传送至地点",
        ["Auto Buy Gear"] = "自动购买装备",
        ["Tween To Highest Mirage"] = "传送至幻影岛最高点",
        ["Find Blue Gear"] = "寻找蓝色装备",
        ["Look Moon Ability"] = "望月激活能力",
        ["Auto Train"] = "自动训练",
        ["Auto Kill Player After Trial"] = "试炼后自动击杀玩家",
        ["Auto Trial"] = "自动试炼",
        ["Auto Kill Player Quest"] = "自动击杀玩家任务",
        ["Aimbot Gun"] = "枪械瞄准",
        ["Aimbot Skill Neares"] = "技能瞄准最近目标",
        ["Aimbot Skill"] = "技能瞄准",
        ["Enable PvP"] = "开启PvP模式",
        ["Selected Chip"] = "选择芯片",
        ["Auto Raid"] = "自动副本",
        ["Auto Awaken"] = "自动觉醒",
        ["Price Devil Fruit"] = "果实解锁价格",
        ["Unstore Devil Fruit"] = "解锁恶魔果实",
        ["Law Raid"] = "罗副本",
        ["Auto Buy Legendary Sword"] = "自动购买传奇剑",
        ["Auto Buy Haki Color"] = "自动购买霸气颜色",
        ["Auto Buy Random Fruit"] = "自动购买随机果实",
        ["Store Rarity Fruit"] = "存储果实稀有度",
        ["Auto Store Fruit"] = "自动存储果实",
        ["Fruit Notification"] = "果实通知",
        ["Teleport To Fruit"] = "传送至果实",
        ["Tween To Fruit"] = "移动至果实",
        ["Hide Chat"] = "隐藏聊天",
        ["Hide Leaderboard"] = "隐藏排行榜",
        ["Highlight Mode"] = "高亮模式",
        ["Auto Elite Hunter"] = "自动精英猎人",
        ["Auto Elite Hunter Hop"] = "精英猎人自动换服",
        ["Selected Bone Farm Method"] = "刷骨头方式",
        ["Auto Farm Bone"] = "自动刷骨头",
        ["Auto Random Surprise"] = "自动随机惊喜",
        ["Auto Pirate Raid"] = "自动海盗突袭",
        ["Auto Farm Chest Tween"] = "自动刷宝箱（移动）",
        ["Auto Farm Chest Instant"] = "自动刷宝箱（瞬间）",
        ["Auto Chest Hop"] = "宝箱自动换服",
        ["Auto Farm Chest Mirage"] = "自动刷幻影宝箱",
        ["Auto Stop Items"] = "获得目标物品后停止",
        ["Auto Farm Katakuri"] = "自动刷卡塔库栗",
        ["Auto Spawn Cake Prince"] = "自动召唤蛋糕王子",
        ["Auto Kill Cake Prince"] = "自动击杀蛋糕王子",
        ["Auto Kill Dough King"] = "自动击杀面团国王",
        ["Selected Material"] = "选择材料",
        ["Auto Farm Material"] = "自动刷材料",
        ["Auto Second Sea"] = "自动解锁第二海",
        ["Auto Third Sea"] = "自动解锁第三海",
        ["Auto Farm Factory"] = "自动刷工厂",
        ["Auto Super Human"] = "自动获取超人",
        ["Auto Death Step"] = "自动获取死步",
        ["Auto Fishman Karate"] = "自动获取鱼人空手道",
        ["Auto Electric Claw"] = "自动获取电爪",
        ["Auto Dragon Talon"] = "自动获取龙爪",
        ["Auto God Human"] = "自动获取神之人类",
        ["Auto Saber"] = "自动获取 saber",
        ["Auto Buddy Sword"] = "自动获取伙伴剑",
        ["Auto Soul Guitar"] = "自动获取灵魂吉他",
        ["Auto Rengoku"] = "自动获取炼狱",
        ["Auto Hallow Scythe"] = "自动获取神圣镰刀",
        ["Auto Warden Sword"] = "自动获取狱卒剑",
        ["Auto Cursed Dual Katana"] = "自动获取诅咒双太刀",
        ["Auto Yama"] = "自动获取山",
        ["Auto Tushita"] = "自动获取天堂",
        ["Auto Canvander"] = "自动获取帆布刀",
        ["Auto Dragon Trident"] = "自动获取龙三叉戟",
        ["Auto Pole"] = "自动获取长杆",
        ["Auto Shawk Saw"] = "自动获取鲨鱼锯",
        ["Auto Greybeard"] = "自动获取白胡子",
        ["Auto Swan Glasses"] = "自动获取天鹅眼镜",
        ["Auto Arena Trainer"] = "自动获取竞技场训练师",
        ["Auto Dark Dagger"] = "自动获取黑暗匕首",
        ["Auto Press Haki Button"] = "自动按霸气按钮",
        ["Auto Rainbow Haki"] = "自动获取彩虹霸气",
        ["Auto Holy Torch"] = "自动获取神圣火炬",
